...
<body>
    ...
    <div class="container">
        <div class="w-100">
            <center>
                <img src="./images/wapda/qesco-logo.png" class="my-5" style="width: 150px; height: 145px; border-radius: 50%" alt="<?php echo $totalPageData[4]; ?>">
            </center>
            <h1 class="text-center">QUETTA ELECTRIC SUPPLY COMPANY</h1>
            <div class="row">
                <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2">
                    <form method="post" action="./pages/qesco/qesco-backend.php">
