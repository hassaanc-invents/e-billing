...
if (isset($_POST['submit'])) {
    ...
    $content = "https://bill.pitc.com.pk/gepcobill/general?refno=" . $referenceNumber;
    $gepcoWebHtml = file_get_contents($content);
    ...
    preg_match_all($meterOwnerRegex, $gepcoWebHtml, $meterOwnerDetail);;
    preg_match_all($getTotalBill, $gepcoWebHtml, $totalBill);
    preg_match_all($getBillAfterDate, $gepcoWebHtml, $billAfterDate);
    preg_match_all($referenceNumberRegex, $gepcoWebHtml, $completeRefNumber);
    preg_match_all($dueDateRegex, $gepcoWebHtml, $dueDate);
    session_start();
