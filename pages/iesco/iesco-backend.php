...
if (isset($_POST['submit'])) {
    ...
    $content = "https://bill.pitc.com.pk/iescobill/general?refno=" . $referenceNumber;
    $iescoWebHtml = file_get_contents($content);
    ...
    preg_match_all($meterOwnerRegex, $iescoWebHtml, $meterOwnerDetail);;
    preg_match_all($getTotalBill, $iescoWebHtml, $totalBill);
    preg_match_all($getBillAfterDate, $iescoWebHtml, $billAfterDate);
    preg_match_all($referenceNumberRegex, $iescoWebHtml, $completeRefNumber);
    preg_match_all($dueDateRegex, $iescoWebHtml, $dueDate);
    session_start();
