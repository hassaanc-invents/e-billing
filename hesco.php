...
<body>
    ...
    <div class="container">
        <div class="w-100">
            <center>
                <img src="./images/wapda/hesco-logo.webp" class="my-5" style="width: 250px; height: 250px; border-radius: 50%" alt="<?php echo $totalPageData[4]; ?>">
            </center>
            <h1 class="text-center">Hyderabad Electric Supply Company</h1>
            <div class="row">
                <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2">
                    <form method="post" action="./pages/hesco/hesco-backend.php">
